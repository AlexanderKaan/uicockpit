...
describe('segment graph integrity', () => {
  ...
  it('tier counts match the registry (Foundation 5 · Component 25 · Section 14 · Atom = rest)', () => {
    ...
    // 25 after the four-layer cut took `danger-zone` and `breakdown`: both were
    // component tier and neither could name a source. (27 before that, since the
    // Open UI pass added `memorable-date` — a fieldset plus three inputs, which
    // is a component because the GROUPING is the component.)
