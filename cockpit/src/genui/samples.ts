...
export const SAMPLES: Record<GenType, GenNode> = {
  ...
  card: { type: 'card', title: 'A card', desc: 'With a description.', badge: { text: 'New', tone: 'primary' }, media: { alt: 'A media slot', label: 'Media' }, well: false, children: [{ type: 'text', text: 'Content in the body.' }], actions: [{ type: 'button', text: 'Primary', variant: 'primary', size: 'sm' }, { type: 'button', text: 'Later', variant: 'ghost', size: 'sm' }] },
